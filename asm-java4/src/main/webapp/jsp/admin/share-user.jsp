...
<c:import url="side-bar.jsp"/>
    <main class="mt-3 container-fluid">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">Shared Friends</a>
        </li>
      </ul>
      <div class="">
  ...
  <option value="Mang thóc về cho mẹ">
      ...
      <div class="mt-3">
        <table class="table table-hover table-striped ">
          ...
          <tbody>
            <tr>
              <td scope="row">Nguyễn Đình Thắng</td>
            ...
            <tr>
              <td scope="row">Nguyễn Phước Quốc</td>
              <td>quocnpps18993@fpt.edu.vn</td>
              <td>nghitvps19009@fpt.edu.vn</td>
              <td>01/01/2022</td>
            </tr>
