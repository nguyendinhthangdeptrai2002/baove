        ...
        <div class="card-body">
          ...
          <form action="login" method="post">
            ...
            <div class="pt-1 d-flex justify-content-between">
              ...
              <a href="forgot-password" class="text-decoration-none " id="forgot-password">Forgot password?</a>
            </div>
            
    
            <div class="row d-flex mt-4 justify-content-center pe-2">
             
              <button class="btn py-2 text-white col-8" id="btn-login" type="submit">Login</button>
            </div>
          </form>
          <div class=" py-2 mt-3 text-center text-muted">Don't have an account? <a href="signup">Cick here</a></div>
        </div>
      </div>
